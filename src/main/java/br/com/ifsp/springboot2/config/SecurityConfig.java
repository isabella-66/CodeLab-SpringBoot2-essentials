...
//                .and()
                ...
                .antMatchers("/animes/admin/**").hasRole("ADMIN") //protege urls - o que vem depois de admins exige role admin
                .antMatchers("/animes/**").hasRole("USER") //mais restritivo primeiro - ordem essencial
